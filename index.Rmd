...
[![](thumbnails/Laredo_interactive.png)](https://alecmartinezgsd.github.io/portfolio/portfolio/fullsize/stuck.html){target="_blank"}
...
[![](thumbnails/empowerment.png)](https://alecmartinezgsd.github.io/portfolio/portfolio/fullsize/empowerment.png){target="_blank"}
...
[![](thumbnails/isochrome.png)](https://alecmartinezgsd.github.io/portfolio/portfolio/fullsize/isochrome.png){target="_blank"}

## Accessibility Scores (as quantified by walksheds around transit stops), Los Angeles, California

[![](thumbnails/access.png)](https://c-voulgaris.github.io/portfolio_examples/fullsize/access.png){target="_blank"}

## Pedestrian Access to Transit Stops (two maps), Los Angeles, California

[![](thumbnails/nebula.png)](https://alecmartinezgsd.github.io/portfolio/portfolio/fullsize/nebula.png){target="_blank"}

[![](thumbnails/shape.png)](https://c-voulgaris.github.io/portfolio_examples/fullsize/shape.pdf){target="_blank"}
...
[![](thumbnails/honolulu.png)](https://alecmartinezgsd.github.io/portfolio/portfolio/fullsize/honolulu.png){target="_blank"}
